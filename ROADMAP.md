...
|-----------|---------|----------------------|-----------|------------|-----------|---------------|
| 1 | Framework / Nền tảng | (hạ tầng — chưa gắn F; đặt nền cho mọi F: schema, lib/db, lib/config, lib/repositories, lib/ai, lib/auth) | MVP | ⬜ chưa làm | — (không phụ thuộc) | [.planning/phase-1-framework-foundation-plan.md](.planning/phase-1-framework-foundation-plan.md) |
...
| 6 | GĐ2 — Audio/Video, YouTube, Ngữ pháp | F6, F7 (+ import phụ đề YouTube) | GĐ2 | ⬜ chưa làm | Phase 2, 3 | [.planning/phase-6-phase2-media-grammar-plan.md](.planning/phase-6-phase2-media-grammar-plan.md) |
